<?php
    class Painel{
        ...
        //alerta para atualização de cadastro do usuario
        ...
        public static function imagemValida($imagem){
            if($imagem['type']== 'image/jpeg' || $imagem['type']== 'image/jpg' || $imagem['type']== 'image/png'){
                ...
                $tamanho = intval($imagem['size'] / 1024); //converter para kb e arredondar
                if($tamanho < 400){
                    return true;
                }else{
                    return false;
        ...
        public static function uploadFile($file){
            //função para criar id unica na imagem
...
//metodo dinamico para inserir no banco de dados
...
// metodo especifico para selecionar unico registro
