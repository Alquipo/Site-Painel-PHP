$(function(){
  ...
  function initialize() {
    ...
    var mapProp = {
      center: new google.maps.LatLng(-21.204538, -41.891303),
      zoom: 14,
      scrollwheel: false,
      styles: [{
        stylers: [{
  ...
  $("nav.mobile").click(function () {
    ...
    //abrir e fechar menu com slideToggle
  ...
  function carregarDinamico() {
    $('[realtime]').click(function(){
      ...
      setTimeout(function(){
        initialize();
        addMarker(-21.204538, -41.891303, '', "Local da Empresa",undefined,false);
      },1000);
